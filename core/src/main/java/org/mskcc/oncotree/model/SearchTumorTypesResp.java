...
public class SearchTumorTypesResp {

    private Meta meta = null;
    private List<TumorType> data = new ArrayList<TumorType>();
    ...
    @ApiModelProperty(value = "")
    @JsonProperty("data")
    public List<TumorType> getData() {
        return data;
    }

    public void setData(List<TumorType> data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        SearchTumorTypesResp searchTumorTypesResp = (SearchTumorTypesResp) o;
